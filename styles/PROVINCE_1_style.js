...
var style_PROVINCE_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("PROV_POP20");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("PROV_POP20") !== null) {
        labelText = String(feature.get("PROV_POP20"));
    }
    if (value >= 70036.000000 && value <= 401506.800000) {
            style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(226,245,241,1.0)'}),
