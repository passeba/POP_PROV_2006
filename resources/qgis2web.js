...
map.getView().fit([-694868.852545, 1026884.794980, 369726.652143, 1722249.847701], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">REPARTITION DE LA POPULATION PAR PROVINCE DU BURKINA FASO EN 2006</h2>';
        return titleElement;
    })(),
